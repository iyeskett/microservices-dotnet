...
{
    public partial class AddingOrderDatatablesOnDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    discoun_amount = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    ...
                    cvv = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    expire_month_year = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    order_total_items = table.Column<int>(type: "int", nullable: false),
